...
; global declarations
;--------------------------------------------------------
	global	_BTN_ComputeState
	global	_BTN_GetPressTime
	global	_BTN_GetState
	global	_BTN_Update
	global	_BTN_Init
...
r0x101C	res	1
_BTNs_Info	res	24
_BTN_Update_BTN_counter_1_16	res	2
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------
;--------------------------------------------------------
...
;***
;entry:  _BTN_ComputeState	;Function start
; 2 exit points
;has an exit
...
;  pBlock Stats: dbName = C
;***
;entry:  _BTN_GetPressTime	;Function start
; 2 exit points
;has an exit
;functions called:
;   __mulchar
...
;  pBlock Stats: dbName = C
;***
;entry:  _BTN_GetState	;Function start
; 2 exit points
;has an exit
;functions called:
;   __mulchar
...
;  pBlock Stats: dbName = C
;***
;entry:  _BTN_Update	;Function start
; 2 exit points
;has an exit
;functions called:
;   __mulchar
...
;;	1028  _BTN_Update_BTN_counter_1_16   offset=0
	BANKSEL	_BTN_Update_BTN_counter_1_16
...
;  pBlock Stats: dbName = C
;***
;entry:  _BTN_Init	;Function start
; 2 exit points
;has an exit
;functions called:
;   __mulchar
...
;	  517+  162 =   679 instructions ( 1682 byte)
