...
;***
;entry:  _HIF_Command	;Function start
; 2 exit points
;has an exit
...
;; ***	genEndFunction  2530
	.line	44; "HIF.c"	}
	RETURN	
; exit point of _HIF_Command

;***
;  pBlock Stats: dbName = C
;***
;entry:  _HIF_Update	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
